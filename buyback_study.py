...
NOTE: this file is a plain-name copy of `buyback_study_TEMPLATE.py` (this folder), kept in sync
so `import buyback_study` resolves for `code/template_test_HD.py`, `code/run_COST.py`, and any
future company driver. `buyback_study_TEMPLATE.py` is the one to edit; copy changes here after.
Last synced 2026-08-12 (third pass, COST run) - both files are byte-identical below this notice.
